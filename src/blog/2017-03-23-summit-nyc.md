...
<div class="bulma-grid bulma-is-col-min-12">
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="http://www.weightwatchers.com/">
        <img src="/img/media/sponsors/weight_watchers.png" alt="Weight Watchers" title="Weight Watchers" style="height:60px" />
      </a>
    </div>
  </div>
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="http://www.cakesolutions.net/">
        <img src="/img/media/sponsors/cake.jpg" alt="Cake Solutions" title="Cake Solutions" style="height:60px" />
      </a>
    </div>
  </div>
  <div class="bulma-cell">
  ...
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://www.tapad.com/">
        <img src="/img/media/sponsors/tapad.png" alt="Tapad" title="Tapad" style="height:60px" />
      </a>
    </div>
  </div>
</div>
...
<div class="bulma-grid bulma-is-col-min-12">
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://www.rallyhealth.com/">
        <img src="/img/media/sponsors/rally.png" alt="Rally Health" title="Rally Health" style="height:60px" />
      </a>
    </div>
  </div>
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://giphy.com/">
        <img src="/img/media/sponsors/giphy.png" alt="Giphy" title="Giphy" style="height:60px" />
      </a>
    </div>
  </div>
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://www.driver.xyz/">
        <img src="/img/media/sponsors/driver.png" alt="Driver" title="Driver" style="height:60px" />
      </a>
    </div>
  </div>
  <div class="bulma-cell">
  ...
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://datamonsters.co/">
        <img src="/img/media/sponsors/data-monsters.png" alt="Data Monsters" title="Data Monsters" style="height:60px" />
      </a>
    </div>
  </div>
</div>
  ...
  <div class="bulma-cell">
    <div class="bulma-has-text-centered">
      <a href="https://www.iheart.com/">
        <img src="/img/media/sponsors/iheartradio.png" alt="iHeartRadio" title="iHeartRadio" style="height:60px" />
      </a>
    </div>
  </div>
</div>
