...
@:style(bulma-cell bulma-has-text-centered)[@:image(/img/media/sponsors/triplequote.png) { alt: Triplequote, title: Triplequote, style: legacy-event-sponsor }](https://www.triplequote.com/)@:@
@:@
