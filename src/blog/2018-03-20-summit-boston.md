...
| 8:15 | Registration & Breakfast by Clover Food Labs |
 ...
 9:05 | @:style(schedule-title)http4s: pure, typeful, functional HTTP in Scala@:@ @:style(schedule-byline)Ross Baker@:@ <p>http4s embraces cats.data.Kleisli for service definitions and fs2.Stream for payload processing. With its foundation on these simple types, we’ll take a whirlwind tour of how http4s can:</p>
